...
const Features = () => {
    return (
        <div className='relative overflow-hidden z-0'>
            ...
            <div className='py-10 md:py-12 lg:py-[60px] xl:py-[70px] px-3 sm:px-5 md:px-[30px] lg:px-[50px] xl:px-[80px] 2xl:px-[100px] flex flex-col gap-7 lg:gap-10 '>
                            ...
                            <div key={index} className='relative overflow-hidden rounded-[12px] backdrop-blur-sm'>
                                ...
                                <div className='p-2.5 lg:p-5 xl:p-10 flex flex-col gap-7 xl:gap-[34px] md:h-full md:justify-between'>
                                    <div className='flex flex-col gap-7 xl:gap-[34px]'>
                                        <div className='px-2.5 lg:px-5 xl:px-10 2xl:px-12 rounded-[16px]'>
                                            {item.component}
                                        </div>
